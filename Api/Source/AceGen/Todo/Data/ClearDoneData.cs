...
public class ClearDoneData : AbstractClearDoneData, IClearDoneData {
	...
	public ClearDoneData( string uuid ) : base(uuid) {
	}

	override public void MigrateLegacyData(String json) {
	}

	public static IClearDoneData GenerateTestData() {
		Random random = new Random();
		IClearDoneData testData = (IClearDoneData) new AceGen.Todo.Models.ClearDoneModel();
